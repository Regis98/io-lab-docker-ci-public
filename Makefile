...
image:
  # TODO: this build command is incomplete, add last flag of this command that tags image as latest upon building it
	docker build \
		...
		-t regis9818/io-lab-docker-ci -t regis9818/io-lab-docker-ci:custom-tag .	
  # TODO: last part of this command that tags just built image with a specyfic tag
	
push:
	docker login
	docker push regis9818/io-lab-docker-ci
	docker push regis9818/io-lab-docker-ci:custom-tag
